...
const Contact = () => {
  ...
  const styles = {
    ...
    ctaSection: {
      padding: isMobile ? "60px 5%" : isTablet ? "70px 6%" : "80px 8%",
      background: "linear-gradient(135deg, #747476 0%, #515050 100%)",
      color: "#f0e9e9",
      textAlign: "center"
    },

    ctaTitle: {
      fontSize: isMobile ? "30px" : isTablet ? "44px" : "clamp(28px, 5vw, 36px)",
      fontWeight: "700",
      marginBottom: "15px"
    },
      ...
      <footer style={styles.footer}>
        <div style={styles.footerContent}>
          ...
          <div>
            ...
            <Link to="/Termsservice" style={styles.footerLink}>Terms of Service</Link>
          </div>
          <div>
