...
export default function Appointment() {
  ...
  // New footer styles copied from About page
  const footerStyles = {
    footer: {
      background: "#0f172a",
      color: "#fff",
    ...
    <div style={{ minHeight: '100vh', backgroundColor: colors.gray[50] }}>
      ...
      <footer style={footerStyles.footer}>
        <div style={footerStyles.footerContent}>
          <div>
            <div style={footerStyles.footerLogo}>ARCTITECH</div>
          ...
          <div>
            ...
            <Link to="/services" style={footerStyles.footerLink}>Services</Link>
            <Link to="/project" style={footerStyles.footerLink}>Projects</Link>
            <Link to="/contact" style={footerStyles.footerLink}>Contact</Link>
            <Link to="/appointment" style={footerStyles.footerLink}>Appointment</Link>
          </div>
          <div>
            <h4 style={{ color: "#fff", marginBottom: isMobile ? "15px" : "24px", fontSize: isMobile ? "18px" : "20px" }}>Legal</h4>
            <Link to="/Privacypolicy" style={footerStyles.footerLink}>Privacy Policy</Link>
            <Link to="/Termsservice" style={footerStyles.footerLink}>Terms of Service</Link>
          </div>
          <div>
